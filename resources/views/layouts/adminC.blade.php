...
<html lang="ja" style="height:100%;">
  ...
  <body style="padding-bottom:43px; position:relative; min-height:100%;">
    <div id="app">
      {{-- 画面上部に表示するナビゲーションバー --}}
      ...
      <main class="pt-4 pb-3" style="height:100%;">
        @yield('content')
      </main>
    </div>

    {{-- フッター --}}
    <footer style="background-color:#343a40; width:100%; position:absolute; bottom:0;">
      <p class="copyright" style="text-align:center; padding:10px; margin-bottom:0; letter-spacing:.05em; color:#f1f3f3;">©️ 2019 naritai.com</p>
    </footer>
